 ...
 * </pre></blockquote>
 *
 * @see com.jfinal.cos.CookieNotFoundException
 *
...
public class CookieParser {
   ...
   * @exception com.jfinal.cos.CookieNotFoundException if the cookie was not found
   */
  public String getStringCookie(String name)
      throws com.jfinal.cos.CookieNotFoundException {
    String value = (String) cookieJar.get(name);
    if (value == null)
      throw new com.jfinal.cos.CookieNotFoundException(name + " not found");
    else
      return value;
  }
  ...
  public byte getByteCookie(String name)
      throws com.jfinal.cos.CookieNotFoundException, NumberFormatException {
  ...
  public char getCharCookie(String name)
    ...
    if (param.length() == 0)
      throw new com.jfinal.cos.CookieNotFoundException(name + " is empty string");
    else
