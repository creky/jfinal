...
import com.jfinal.cos.multipart.*;
...
public class MultipartRequest {
  ...
  public void parse(HttpServletRequest request,
    ...
    if (request.getQueryString() != null) {
      ...
      Map queryParameters = request.getParameterMap();
      // For our own use, name it a name->Vector structure
      Set queryParameterNames = queryParameters.keySet();
      Iterator itor=queryParameterNames.iterator();
      while (itor.hasNext()) {
        Object paramName = itor.next();
